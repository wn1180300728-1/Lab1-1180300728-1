...
public class MagicSquare {
	public static void main(String[] args) throws IOException{
		...
		System.out.println("文件一:"+isLegalMagicSquare("src/P1/txt/1.txt"));
		System.out.println("文件二:"+isLegalMagicSquare("src/P1/txt/2.txt"));
		System.out.println("文件三:"+isLegalMagicSquare("src/P1/txt/3.txt"));
		System.out.println("文件四:"+isLegalMagicSquare("src/P1/txt/4.txt"));
		System.out.println("文件五:"+isLegalMagicSquare("src/P1/txt/5.txt"));
